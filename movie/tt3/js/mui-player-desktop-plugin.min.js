	...
	return function(m) {
		...
		function r(e) {
			"statics" == e && (g = (new u).defaults, v.initSubtitleOption() && g.push(v.initSubtitleOption())),
				!g.map(function(e) {
					return e.name
				}).includes("subtitle") && "statics" != e && v.initSubtitleOption() && g.push(v
					.initSubtitleOption());
		...
		var t = this,
			...
			n = {
				...
				confirmKeyDown: function(e) {
					(new t.interface)._onAgentMpTap("click"), n.escKeyDown()
				},
			...
			y = {
				...
				addFocusKeyboardHandle: function() {
					for (var e = f.$el.mPlayer.querySelectorAll(".keyboard-input"), t = 0; t < e
						...
						var t = f.$method.getKeyCode(e),
							...
							.indexOf(t) && ((new y.popupInstance).togglePopupVisible("OFF"), 32 !=
								t && ("setting-switch" != o ? "volume-switch" != o ? e.currentTarget
									.click() : s.showVolumePopup(e) : v.showSettingPopup(e)))
				...
				toggles: function() {
					this.pageFull = function(e) {
						function t() {
							l.contains("page-fullscreen") || (f._this._global_.webpagePlugin
								.isPagefull = !0, f.$el.mPlayer.classList.add("page-fullscreen"), n[
									0].style.display = "none", n[1].style.display = "block", n[0]
								.parentNode.setAttribute("tooltip", f.$method.getLangObject()
									.exitPageScreen), f._this.emit("pagefull-change", {
									pagefull: !0
						...
						function o() {
							l.contains("page-fullscreen") && (f._this._global_.webpagePlugin
								.isPagefull = !1, f.$el.mPlayer.classList.remove("page-fullscreen"),
								n[0].style.display = "block", n[1].style.display = "none", n[0]
								.parentNode.setAttribute("tooltip", f.$method.getLangObject()
									.pageScreen), f._this.emit("pagefull-change", {
									pagefull: !1
								})), e instanceof Object && f.$method.changeVideoSize({
								type: "pagefulll"
							})
				...
				onControlsToggle: function(e) {
					...
					function t(e) {
						f.$el.mPlayer.style.cursor = e
					}
					f._this._global_.webpagePlugin.timer_2 && clearTimeout(f._this._global_.webpagePlugin
							.timer_2), e.show || !f.$data.isFullScreen && !f._this._global_.webpagePlugin
						.isPagefull ? t("default") : f._this._global_.webpagePlugin.timer_2 = setTimeout(
							function() {
								t("none")
							}, 1e3)
				},
