	...
	var MuiPlayer = function MuiPlayer(config) {
		...
		con && ($CONSTANT = {
				...
				getLanguageText: function() {
					return {
						"zh-cn": {
							...
							playbackSpeed: "播放速度",
							share: "分享",
							pictureInPicture: "小窗模式",
							exitPictureInPicture: "退出小窗模式",
							pageScreen: "网页全屏",
				...
				initConfigCustom: function(e) {
					for (var t = option.custom || {}, o = t.headControls || [], r = 0; r < o.length && !
						(5 <= r); r++) o[r] instanceof Object && o[r].slot && (l = o[r].slot, (i = $el
						...
						.setAttribute("control", ""), o[r].click instanceof Function && s
						.classList.add("keyboard-input"), o[r].style && o[r]
						.style instanceof Object && $method.setElementStyle(s, o[r].style), s
						.appendChild(a), e.querySelector("#buttom-group").insertBefore(s, e
							.querySelector("#buttom-group .header-control")), i.style.display =
						"none"));
					for (var n = t.footerControls || [], r = 0; r < n.length && !(5 <= r); r++) n[
						r] instanceof Object && n[r].slot && (l = n[r].slot, (i = $el.mPlayer
							...
							.setAttribute("control", ""), n[r].tooltip && s.setAttribute("tooltip",
								n[r].tooltip), n[r].click instanceof Function && s.classList.add(
								"keyboard-input"), n[r].style && n[r].style instanceof Object &&
							$method.setElementStyle(s, n[r].style), s.appendChild(a), "left" == n[r]
							...
							.style.display = "none"));
					for (var l, i, a, s, c, d = t.rightSidebar || [], r = 0; r < d.length && !(5 <=
						r); r++) d[r] instanceof Object && d[r].slot && (l = d[r].slot, (i = $el.mPlayer
						.querySelector("[slot=" + l + "]")) && (a = "TEMPLATE" == i.tagName ? i
						.content.cloneNode(!0) : $method.createRangeIsDocFragment(i.innerHTML),
						(s = document.createElement("div")).appendChild(a), s.setAttribute(
							"slot", l), s.setAttribute("class", "mplayer-sidebar"), c = d[r]
					...
					if ("[object Array]" === Object.prototype.toString.call(o) && 0 < o.length) {
						for (var n = document.createDocumentFragment(), l = 0; l < o.length; l++) {
							...
							"object" == _typeof(a) && /.\.vtt$/.test(a.src) && ((i = document
								...
								.setAttribute("default", !0), n.appendChild(i))
						}
						e.querySelector("video").appendChild(n)
					}
					if ("[object Object]" == Object.prototype.toString.call(r) && 0 < Object.keys(r)
						.length) {
					...
					function i(e, t) {
						...
						if ("src" == e) {
							var r = option.parse || {},
								...
								l = r.loader,
								i = r.config || {};
							if (r.customKernel && r.customKernel instanceof Function) return console
								.info("custom kernel..."), r.customKernel(o, t), 0;
							...
							"flv" == n && "object" == _typeof(l) && (1 == l.isSupported() ? $method
								.flvDecodeAction(o, t, {
									loader: l,
									config: i
								}) : console.error(
				...
				hlsDecodeAction: function(e, t, o) {
					...
					(hls = new o.loader(r)).attachMedia(e), hls.on(o.loader.Events.MEDIA_ATTACHED,
						function() {
							hls.loadSource(t)
				...
				changeVideoSize: function(e) {
					...
					"[object Array]" === Object.prototype.toString.call(e) && 0 < e.length && l
						.videoHeight && l.videoWidth && "window" == $method.returnSys() && (e = $el
							.mPlayer.getBoundingClientRect(), t = e.width, o = e.height, r = l
							.videoHeight / l.videoWidth, n = o / t, !(e = $el.mPlayer.classList)
							.contains("browser-fullscreen") && !e.contains("page-fullscreen") && 0 !=
							option.autoFit || n.toFixed(2) > r.toFixed(2) ? (l.style.width = t
							.toFixed() + "px", l.style.height = (t * r).toFixed() + "px") : n.toFixed(
							2) < r.toFixed(2) ? (l.style.height = o.toFixed() + "px", l.style.width = (
								o / r).toFixed() + "px") : (l.style.width = t.toFixed() + "px", l.style
								.height = o.toFixed() + "px"))
				},
				onPause: function(e) {
						...
						var r = ["webkitTransform", "transform", "msTransform"],
							...
							n = function() {
								...
								for (var e = $el.mplayerHeader.getBoundingClientRect().height, t =
									0; t < r.length; t++) $el.mplayerHeader.style[r[t]] =
									"translateY(" + -e + "px)"
							},
							l = function() {
							...
							t = function() {
								...
								for (var e = $el.mplayerFooter.getBoundingClientRect().height, t = $el
										...
										.parseInt($el.progressContainer.getBoundingClientRect().height /
											2) + 1 : 0, o = 0; o < r.length; o++) $el.mplayerFooter
									.style[r[o]] = "translateY(" + (e + t) + "px)";
				...
				destory: function() {
					...
					$el.mPlayer.querySelector("#mplayer-media-wrapper video") && ($data.isDestory = !0,
						...
						.toggleEventListenerCustom("remove"), $el.mPlayer.classList.remove(
							"fullscreen-scaling"), hls && hls.media && (hls.destroy(), hls = ""),
						flv && (flv.destroy(), flv = ""), t = (e = $el.mPlayer.querySelector(
							"#mplayer-media-wrapper")).querySelector("video"), o = (r = e
							.getBoundingClientRect()).height, r = r.width, document
						.pictureInPictureElement == t && document.exitPictureInPicture(), e.style
						.height = o + "px", e.style.width = r + "px", t.pause(), t.removeAttribute(
				...
				showToast: function() {
					...
					n.querySelector("#mplayer-toast") && $method.removeNode(n, "#mplayer-toast"), (r =
							document.createElement("div")).setAttribute("class",
							"mplayer-toast toast-scaling"), r.setAttribute("id", "mplayer-toast"), r
				...
				toggleControlsStyle: function(e) {
					for (var t, o = (option.custom || {}).footerControls || [], r = 0; r < o
						.length; r++) !0 !== o[r].oftenShow && (t = o[r].slot, (t = $el.mplayerFooter
					...
					var e = new MutationObserver(function(e, t) {
							...
							try {
								for (r.s(); !(o = r.n()).done;) {
									var n = o.value;
									if ("childList" === n.type) {
										var l, i = _createForOfIteratorHelper(n.removedNodes);
										try {
											for (i.s(); !(l = i.n()).done;) {
												var a = l.value;
												if (a instanceof HTMLVideoElement) {
													hls && hls.media && (hls.destroy(), hls = ""),
														flv && (flv.destroy(), flv = ""), document
														.pictureInPictureElement == a && document
														.exitPictureInPicture(), a.pause(), a
														.removeAttribute("src"), t.disconnect();
													break
												}
											}
										} catch (e) {
				...
				toggleEventListenerCustom: function(e) {
					var t = option.custom || {},
						...
						r = t.headControls || [];
					if (0 < r.length)
						for (var n = 0; n < r.length; n++) !r[n].click instanceof Function || (i = r[n]
							.slot, (a = $el.headerMenu.querySelector("[slot=" + i +
							"]")) instanceof Element && a[o]("click", r[n].click));
					var l = t.footerControls || [];
					if (0 < l.length)
						for (var i, a, n = 0; n < l.length; n++) !l[n].click instanceof Function || (i =
							l[n].slot, (a = $el.mplayerFooter.querySelector("[slot=" + i +
							"]")) instanceof Element && a[o]("click", l[n].click))
				},
				toggleEventListenerGlobal: function(e, t) {
					var o, r = "add" == e ? "addEventListener" : "removeEventListener";
					o = "onorientationchange" in window ? "orientationchange" : "resize", window[r](o,
							$method.onScreenResize), $el.backButton[r]("click", $method.onBack), $el
						.fullSwitch[r]("click", $method.fullToggle), $el.playSwitch[r]("click", $method
							.onPlayTap), $el.mPlayer[r]("click", $method.onContrainerTap), $el.mPlayer[
							r]("dblclick", $method.onContrainerTap), $el
						.touchEffective instanceof Element && $el.touchEffective[r]("touchstart",
							$method.progressBarSeeking), $el.touchEffective instanceof Element && $el
						.touchEffective[r]("mousedown", $method.progressBarSeeking), $el.videoObject[r](
							"webkitbeginfullscreen", $method.runtimeCompatibleHandle), $el.videoObject[
							r]("webkitendfullscreen", $method.runtimeCompatibleHandle), document[r](
							"resume", $method.plusRuntimeHandle), document[r]("pause", $method
							.plusRuntimeHandle), document[r]("visibilitychange", $method
